...
Available ISOs can be obtained using `/v1/isos`.
	...
	*/
	...
	/*
	AttachSecurityGroups Attach security groups to instance

	Attach security groups to an instance

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiAttachSecurityGroupsRequest
	*/
	AttachSecurityGroups(ctx context.Context, instanceId string) ApiAttachSecurityGroupsRequest

	// AttachSecurityGroupsExecute executes the request
	AttachSecurityGroupsExecute(r ApiAttachSecurityGroupsRequest) (*http.Response, error)

	/*
	AuthorizeSecurityGroupFirewallRules Add firewall rules to security group

	Add firewall rules to security group

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param securityGroupId Security Group ID
	@return ApiAuthorizeSecurityGroupFirewallRulesRequest
	*/
	AuthorizeSecurityGroupFirewallRules(ctx context.Context, securityGroupId string) ApiAuthorizeSecurityGroupFirewallRulesRequest

	// AuthorizeSecurityGroupFirewallRulesExecute executes the request
	AuthorizeSecurityGroupFirewallRulesExecute(r ApiAuthorizeSecurityGroupFirewallRulesRequest) (*http.Response, error)
	...
	*/
	...
	/*
	CreateNotificationSetting Create a notification setting

	Create a notification setting

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@param notificationSettingId Notification Setting ID
	@return ApiCreateNotificationSettingRequest
	*/
	CreateNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiCreateNotificationSettingRequest

	// CreateNotificationSettingExecute executes the request
	//  @return NotificationSetting
	CreateNotificationSettingExecute(r ApiCreateNotificationSettingRequest) (*NotificationSetting, *http.Response, error)
...
Allowed only one snapshot per instance.
	...
	*/
	...
	/*
	DeleteNotificationSetting Delete a notification setting setting
	...
	*/
	DeleteNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiDeleteNotificationSettingRequest

	// DeleteNotificationSettingExecute executes the request
	DeleteNotificationSettingExecute(r ApiDeleteNotificationSettingRequest) (*http.Response, error)
	...
	*/
	...
	/*
	DetachSecurityGroups Detach security groups from instance

	Detach security groups from an instance

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiDetachSecurityGroupsRequest
	*/
	DetachSecurityGroups(ctx context.Context, instanceId string) ApiDetachSecurityGroupsRequest

	// DetachSecurityGroupsExecute executes the request
	DetachSecurityGroupsExecute(r ApiDetachSecurityGroupsRequest) (*http.Response, error)

	/*
	EnableInstanceMonitoring Enable monitoring

	Enable service monitoring

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiEnableInstanceMonitoringRequest
	*/
	EnableInstanceMonitoring(ctx context.Context, instanceId string) ApiEnableInstanceMonitoringRequest

	// EnableInstanceMonitoringExecute executes the request
	EnableInstanceMonitoringExecute(r ApiEnableInstanceMonitoringRequest) (*http.Response, error)

	/*
	EnableLoadBalancerMonitoring Enable monitoring

	Enable service monitoring

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param loadBalancerId Load balancer ID
	@return ApiEnableLoadBalancerMonitoringRequest
	*/
	EnableLoadBalancerMonitoring(ctx context.Context, loadBalancerId string) ApiEnableLoadBalancerMonitoringRequest

	// EnableLoadBalancerMonitoringExecute executes the request
	EnableLoadBalancerMonitoringExecute(r ApiEnableLoadBalancerMonitoringRequest) (*http.Response, error)
	...
	*/
	...
	/*
	GetInstanceMonitoringStatus Get service monitoring status

	Get monitoring status

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiGetInstanceMonitoringStatusRequest
	*/
	GetInstanceMonitoringStatus(ctx context.Context, instanceId string) ApiGetInstanceMonitoringStatusRequest

	// GetInstanceMonitoringStatusExecute executes the request
	//  @return SchemasMonitoringStatus
	GetInstanceMonitoringStatusExecute(r ApiGetInstanceMonitoringStatusRequest) (*SchemasMonitoringStatus, *http.Response, error)

	/*
	GetInstanceSecurityGroups Get Instance Security Groups

	List security groups associated with the instance

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiGetInstanceSecurityGroupsRequest
	*/
	GetInstanceSecurityGroups(ctx context.Context, instanceId string) ApiGetInstanceSecurityGroupsRequest

	// GetInstanceSecurityGroupsExecute executes the request
	//  @return InstanceSecurityGroups
	GetInstanceSecurityGroupsExecute(r ApiGetInstanceSecurityGroupsRequest) (*InstanceSecurityGroups, *http.Response, error)
	...
	*/
	...
	/*
	GetLoadBalancerMonitoringStatus Get service monitoring status

	Get monitoring status

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param loadBalancerId Load balancer ID
	@return ApiGetLoadBalancerMonitoringStatusRequest
	*/
	GetLoadBalancerMonitoringStatus(ctx context.Context, loadBalancerId string) ApiGetLoadBalancerMonitoringStatusRequest

	// GetLoadBalancerMonitoringStatusExecute executes the request
	//  @return SchemasMonitoringStatus
	GetLoadBalancerMonitoringStatusExecute(r ApiGetLoadBalancerMonitoringStatusRequest) (*SchemasMonitoringStatus, *http.Response, error)
	...
	*/
	...
	/*
	GetNotificationSetting Get details of a notification Setting
	...
	*/
	GetNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiGetNotificationSettingRequest

	// GetNotificationSettingExecute executes the request
	//  @return NotificationSetting
	GetNotificationSettingExecute(r ApiGetNotificationSettingRequest) (*NotificationSetting, *http.Response, error)

	/*
	GetNotificationSettingList List the notification settings of a customer

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiGetNotificationSettingListRequest
	*/
	GetNotificationSettingList(ctx context.Context, instanceId string) ApiGetNotificationSettingListRequest

	// GetNotificationSettingListExecute executes the request
	//  @return GetNotificationSettingListResult
	GetNotificationSettingListExecute(r ApiGetNotificationSettingListRequest) (*GetNotificationSettingListResult, *http.Response, error)
	...
	*/
	...
	/*
	GetSecurityGroupFirewallRules Get Security Group Firewall Rules

	Get firewall rules for a security group

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param securityGroupId Security Group ID
	@return ApiGetSecurityGroupFirewallRulesRequest
	*/
	GetSecurityGroupFirewallRules(ctx context.Context, securityGroupId string) ApiGetSecurityGroupFirewallRulesRequest

	// GetSecurityGroupFirewallRulesExecute executes the request
	//  @return GetSecurityGroupFirewallRulesResult
	GetSecurityGroupFirewallRulesExecute(r ApiGetSecurityGroupFirewallRulesRequest) (*GetSecurityGroupFirewallRulesResult, *http.Response, error)

	/*
	GetSecurityGroupList Get Security Group list

	List and filter security groups

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSecurityGroupListRequest
	*/
	GetSecurityGroupList(ctx context.Context) ApiGetSecurityGroupListRequest

	// GetSecurityGroupListExecute executes the request
	//  @return SecurityGroupList
	GetSecurityGroupListExecute(r ApiGetSecurityGroupListRequest) (*SecurityGroupList, *http.Response, error)
	...
	*/
	...
	/*
	GetUserData Get User Data supplied while launching the instance.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param instanceId Instance's ID
	@return ApiGetUserDataRequest
	*/
	GetUserData(ctx context.Context, instanceId string) ApiGetUserDataRequest

	// GetUserDataExecute executes the request
	//  @return GetUserDataResult
	GetUserDataExecute(r ApiGetUserDataRequest) (*GetUserDataResult, *http.Response, error)
...
Only works for IPv4.
	...
	*/
	...
	/*
	RefreshAutoScalingGroupImage Refresh auto scaling group image

	Refresh image for auto scaling group

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param autoScalingGroupId Auto Scaling Group ID
	@return ApiRefreshAutoScalingGroupImageRequest
	*/
	RefreshAutoScalingGroupImage(ctx context.Context, autoScalingGroupId string) ApiRefreshAutoScalingGroupImageRequest

	// RefreshAutoScalingGroupImageExecute executes the request
	RefreshAutoScalingGroupImageExecute(r ApiRefreshAutoScalingGroupImageRequest) (*http.Response, error)
...
You can obtain the new credential using the credentials endpoints
	...
	*/
	...
	/*
	RevokeSecurityGroupFirewallRules Remove firewall rules from security group

	Remove firewall rules from security group

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param securityGroupId Security Group ID
	@return ApiRevokeSecurityGroupFirewallRulesRequest
	*/
	RevokeSecurityGroupFirewallRules(ctx context.Context, securityGroupId string) ApiRevokeSecurityGroupFirewallRulesRequest

	// RevokeSecurityGroupFirewallRulesExecute executes the request
	RevokeSecurityGroupFirewallRulesExecute(r ApiRevokeSecurityGroupFirewallRulesRequest) (*http.Response, error)
...
Eligible instance types for update can be obtained using `/v1/instances/{instanceId}/instanceTypesUpdate`.
	...
	*/
	...
	/*
	UpdateNotificationSetting Update Notification Setting details
	...
	*/
	UpdateNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiUpdateNotificationSettingRequest

	// UpdateNotificationSettingExecute executes the request
	//  @return NotificationSetting
	UpdateNotificationSettingExecute(r ApiUpdateNotificationSettingRequest) (*NotificationSetting, *http.Response, error)
...
type ApiAttachSecurityGroupsRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	instanceId string
	attachSecurityGroupsOpts *AttachSecurityGroupsOpts
}

func (r ApiAttachSecurityGroupsRequest) AttachSecurityGroupsOpts(attachSecurityGroupsOpts AttachSecurityGroupsOpts) ApiAttachSecurityGroupsRequest {
	r.attachSecurityGroupsOpts = &attachSecurityGroupsOpts
	return r
}

func (r ApiAttachSecurityGroupsRequest) Execute() (*http.Response, error) {
	return r.ApiService.AttachSecurityGroupsExecute(r)
}
...
Attach security groups to an instance
 ...
 @return ApiAttachSecurityGroupsRequest
*/
func (a *PubliccloudAPIService) AttachSecurityGroups(ctx context.Context, instanceId string) ApiAttachSecurityGroupsRequest {
	return ApiAttachSecurityGroupsRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
func (a *PubliccloudAPIService) AttachSecurityGroupsExecute(r ApiAttachSecurityGroupsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.AttachSecurityGroups")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instanceId}/attachSecurityGroups"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.attachSecurityGroupsOpts == nil {
		return nil, reportError("attachSecurityGroupsOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.attachSecurityGroupsOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
type ApiAuthorizeSecurityGroupFirewallRulesRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	securityGroupId string
	authorizeFirewallRulesOpts *AuthorizeFirewallRulesOpts
}

func (r ApiAuthorizeSecurityGroupFirewallRulesRequest) AuthorizeFirewallRulesOpts(authorizeFirewallRulesOpts AuthorizeFirewallRulesOpts) ApiAuthorizeSecurityGroupFirewallRulesRequest {
	r.authorizeFirewallRulesOpts = &authorizeFirewallRulesOpts
	return r
}

func (r ApiAuthorizeSecurityGroupFirewallRulesRequest) Execute() (*http.Response, error) {
	return r.ApiService.AuthorizeSecurityGroupFirewallRulesExecute(r)
}
...
Add firewall rules to security group
 ...
 @return ApiAuthorizeSecurityGroupFirewallRulesRequest
*/
func (a *PubliccloudAPIService) AuthorizeSecurityGroupFirewallRules(ctx context.Context, securityGroupId string) ApiAuthorizeSecurityGroupFirewallRulesRequest {
	return ApiAuthorizeSecurityGroupFirewallRulesRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
func (a *PubliccloudAPIService) AuthorizeSecurityGroupFirewallRulesExecute(r ApiAuthorizeSecurityGroupFirewallRulesRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.AuthorizeSecurityGroupFirewallRules")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/securityGroups/{securityGroupId}/authorizeFirewallRules"
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.authorizeFirewallRulesOpts == nil {
		return nil, reportError("authorizeFirewallRulesOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.authorizeFirewallRulesOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
type ApiCreateNotificationSettingRequest struct {
	...
	createNotificationSettingOpts *CreateNotificationSettingOpts
}

func (r ApiCreateNotificationSettingRequest) CreateNotificationSettingOpts(createNotificationSettingOpts CreateNotificationSettingOpts) ApiCreateNotificationSettingRequest {
	r.createNotificationSettingOpts = &createNotificationSettingOpts
	return r
}

func (r ApiCreateNotificationSettingRequest) Execute() (*NotificationSetting, *http.Response, error) {
...
Create a notification setting
 ...
 @return ApiCreateNotificationSettingRequest
*/
func (a *PubliccloudAPIService) CreateNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiCreateNotificationSettingRequest {
	return ApiCreateNotificationSettingRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return NotificationSetting
func (a *PubliccloudAPIService) CreateNotificationSettingExecute(r ApiCreateNotificationSettingRequest) (*NotificationSetting, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.CreateNotificationSetting")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instanceId}/notificationSettings/dataTraffic/{notificationSettingId}"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createNotificationSettingOpts == nil {
		return localVarReturnValue, nil, reportError("createNotificationSettingOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createNotificationSettingOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
type ApiCreateSecurityGroupRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	createSecurityGroupOpts *CreateSecurityGroupOpts
}

func (r ApiCreateSecurityGroupRequest) CreateSecurityGroupOpts(createSecurityGroupOpts CreateSecurityGroupOpts) ApiCreateSecurityGroupRequest {
	r.createSecurityGroupOpts = &createSecurityGroupOpts
	return r
}
...
Create a Security Group
 ...
 @return ApiCreateSecurityGroupRequest
*/
func (a *PubliccloudAPIService) CreateSecurityGroup(ctx context.Context) ApiCreateSecurityGroupRequest {
	return ApiCreateSecurityGroupRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SecurityGroup
func (a *PubliccloudAPIService) CreateSecurityGroupExecute(r ApiCreateSecurityGroupRequest) (*SecurityGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.CreateSecurityGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createSecurityGroupOpts == nil {
		return localVarReturnValue, nil, reportError("createSecurityGroupOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createSecurityGroupOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
func (r ApiDeleteNotificationSettingRequest) Execute() (*http.Response, error) {
...
DeleteNotificationSetting Delete a notification setting setting
 ...
 @return ApiDeleteNotificationSettingRequest
*/
func (a *PubliccloudAPIService) DeleteNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiDeleteNotificationSettingRequest {
	return ApiDeleteNotificationSettingRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
func (a *PubliccloudAPIService) DeleteNotificationSettingExecute(r ApiDeleteNotificationSettingRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.DeleteNotificationSetting")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Delete a Security Group
 ...
 @return ApiDeleteSecurityGroupRequest
*/
func (a *PubliccloudAPIService) DeleteSecurityGroup(ctx context.Context, securityGroupId string) ApiDeleteSecurityGroupRequest {
	return ApiDeleteSecurityGroupRequest{
		ApiService: a,
		ctx: ctx,
		securityGroupId: securityGroupId,
...
// Execute executes the request
func (a *PubliccloudAPIService) DeleteSecurityGroupExecute(r ApiDeleteSecurityGroupRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.DeleteSecurityGroup")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/securityGroups/{securityGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"securityGroupId"+"}", url.PathEscape(parameterValueToString(r.securityGroupId, "securityGroupId")), -1)
...
type ApiDetachSecurityGroupsRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	instanceId string
	detachSecurityGroupsOpts *DetachSecurityGroupsOpts
}

func (r ApiDetachSecurityGroupsRequest) DetachSecurityGroupsOpts(detachSecurityGroupsOpts DetachSecurityGroupsOpts) ApiDetachSecurityGroupsRequest {
	r.detachSecurityGroupsOpts = &detachSecurityGroupsOpts
	return r
}

func (r ApiDetachSecurityGroupsRequest) Execute() (*http.Response, error) {
	return r.ApiService.DetachSecurityGroupsExecute(r)
}
...
Detach security groups from an instance
 ...
 @return ApiDetachSecurityGroupsRequest
*/
func (a *PubliccloudAPIService) DetachSecurityGroups(ctx context.Context, instanceId string) ApiDetachSecurityGroupsRequest {
	return ApiDetachSecurityGroupsRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
func (a *PubliccloudAPIService) DetachSecurityGroupsExecute(r ApiDetachSecurityGroupsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.DetachSecurityGroups")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instanceId}/detachSecurityGroups"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.detachSecurityGroupsOpts == nil {
		return nil, reportError("detachSecurityGroupsOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.detachSecurityGroupsOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
type ApiEnableInstanceMonitoringRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	instanceId string
}

func (r ApiEnableInstanceMonitoringRequest) Execute() (*http.Response, error) {
	return r.ApiService.EnableInstanceMonitoringExecute(r)
}
...
Enable service monitoring
 ...
 @return ApiEnableInstanceMonitoringRequest
*/
func (a *PubliccloudAPIService) EnableInstanceMonitoring(ctx context.Context, instanceId string) ApiEnableInstanceMonitoringRequest {
	return ApiEnableInstanceMonitoringRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
func (a *PubliccloudAPIService) EnableInstanceMonitoringExecute(r ApiEnableInstanceMonitoringRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.EnableInstanceMonitoring")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instance/{instanceId}/monitoring/enable"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
type ApiEnableLoadBalancerMonitoringRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	loadBalancerId string
}

func (r ApiEnableLoadBalancerMonitoringRequest) Execute() (*http.Response, error) {
	return r.ApiService.EnableLoadBalancerMonitoringExecute(r)
}
...
Enable service monitoring
 ...
 @return ApiEnableLoadBalancerMonitoringRequest
*/
func (a *PubliccloudAPIService) EnableLoadBalancerMonitoring(ctx context.Context, loadBalancerId string) ApiEnableLoadBalancerMonitoringRequest {
	return ApiEnableLoadBalancerMonitoringRequest{
		ApiService: a,
		ctx: ctx,
		loadBalancerId: loadBalancerId,
...
// Execute executes the request
func (a *PubliccloudAPIService) EnableLoadBalancerMonitoringExecute(r ApiEnableLoadBalancerMonitoringRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.EnableLoadBalancerMonitoring")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/loadBalancers/{loadBalancerId}/monitoring/enable"
	localVarPath = strings.Replace(localVarPath, "{"+"loadBalancerId"+"}", url.PathEscape(parameterValueToString(r.loadBalancerId, "loadBalancerId")), -1)
...
func (r ApiGetInstanceListRequest) SecurityGroupIds(securityGroupIds string) ApiGetInstanceListRequest {
...
func (a *PubliccloudAPIService) GetInstanceListExecute(r ApiGetInstanceListRequest) (*InstanceList, *http.Response, error) {
	...
	if r.securityGroupIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "securityGroupIds", r.securityGroupIds, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiGetInstanceMonitoringStatusRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	instanceId string
}

func (r ApiGetInstanceMonitoringStatusRequest) Execute() (*SchemasMonitoringStatus, *http.Response, error) {
	return r.ApiService.GetInstanceMonitoringStatusExecute(r)
}
...
Get monitoring status
 ...
 @return ApiGetInstanceMonitoringStatusRequest
*/
func (a *PubliccloudAPIService) GetInstanceMonitoringStatus(ctx context.Context, instanceId string) ApiGetInstanceMonitoringStatusRequest {
	return ApiGetInstanceMonitoringStatusRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return SchemasMonitoringStatus
func (a *PubliccloudAPIService) GetInstanceMonitoringStatusExecute(r ApiGetInstanceMonitoringStatusRequest) (*SchemasMonitoringStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SchemasMonitoringStatus
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetInstanceMonitoringStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instance/{instanceId}/monitoring/status"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
type ApiGetInstanceSecurityGroupsRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	instanceId string
	limit *int32
...
// Limit the number of results returned.
func (r ApiGetInstanceSecurityGroupsRequest) Limit(limit int32) ApiGetInstanceSecurityGroupsRequest {
	r.limit = &limit
	return r
}

// Return results starting from the given offset.
func (r ApiGetInstanceSecurityGroupsRequest) Offset(offset int32) ApiGetInstanceSecurityGroupsRequest {
	r.offset = &offset
	return r
}

func (r ApiGetInstanceSecurityGroupsRequest) Execute() (*InstanceSecurityGroups, *http.Response, error) {
	return r.ApiService.GetInstanceSecurityGroupsExecute(r)
}
...
List security groups associated with the instance
 ...
 @return ApiGetInstanceSecurityGroupsRequest
*/
func (a *PubliccloudAPIService) GetInstanceSecurityGroups(ctx context.Context, instanceId string) ApiGetInstanceSecurityGroupsRequest {
	return ApiGetInstanceSecurityGroupsRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return InstanceSecurityGroups
func (a *PubliccloudAPIService) GetInstanceSecurityGroupsExecute(r ApiGetInstanceSecurityGroupsRequest) (*InstanceSecurityGroups, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InstanceSecurityGroups
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetInstanceSecurityGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instanceId}/securityGroups"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
type ApiGetLoadBalancerMonitoringStatusRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	loadBalancerId string
}

func (r ApiGetLoadBalancerMonitoringStatusRequest) Execute() (*SchemasMonitoringStatus, *http.Response, error) {
	return r.ApiService.GetLoadBalancerMonitoringStatusExecute(r)
}
...
Get monitoring status
 ...
 @return ApiGetLoadBalancerMonitoringStatusRequest
*/
func (a *PubliccloudAPIService) GetLoadBalancerMonitoringStatus(ctx context.Context, loadBalancerId string) ApiGetLoadBalancerMonitoringStatusRequest {
	return ApiGetLoadBalancerMonitoringStatusRequest{
		ApiService: a,
		ctx: ctx,
		loadBalancerId: loadBalancerId,
...
// Execute executes the request
//  @return SchemasMonitoringStatus
func (a *PubliccloudAPIService) GetLoadBalancerMonitoringStatusExecute(r ApiGetLoadBalancerMonitoringStatusRequest) (*SchemasMonitoringStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetLoadBalancerMonitoringStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/loadBalancers/{loadBalancerId}/monitoring/status"
	localVarPath = strings.Replace(localVarPath, "{"+"loadBalancerId"+"}", url.PathEscape(parameterValueToString(r.loadBalancerId, "loadBalancerId")), -1)
...
func (r ApiGetNotificationSettingRequest) Execute() (*NotificationSetting, *http.Response, error) {
...
GetNotificationSetting Get details of a notification Setting
 ...
 @return ApiGetNotificationSettingRequest
*/
func (a *PubliccloudAPIService) GetNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiGetNotificationSettingRequest {
	return ApiGetNotificationSettingRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return NotificationSetting
func (a *PubliccloudAPIService) GetNotificationSettingExecute(r ApiGetNotificationSettingRequest) (*NotificationSetting, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetNotificationSetting")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Limit the number of results returned.
func (r ApiGetNotificationSettingListRequest) Limit(limit int32) ApiGetNotificationSettingListRequest {
	r.limit = &limit
	return r
}

// Return results starting from the given offset.
func (r ApiGetNotificationSettingListRequest) Offset(offset int32) ApiGetNotificationSettingListRequest {
	r.offset = &offset
	return r
}

func (r ApiGetNotificationSettingListRequest) Execute() (*GetNotificationSettingListResult, *http.Response, error) {
...
GetNotificationSettingList List the notification settings of a customer
 ...
 @return ApiGetNotificationSettingListRequest
*/
func (a *PubliccloudAPIService) GetNotificationSettingList(ctx context.Context, instanceId string) ApiGetNotificationSettingListRequest {
	return ApiGetNotificationSettingListRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return GetNotificationSettingListResult
func (a *PubliccloudAPIService) GetNotificationSettingListExecute(r ApiGetNotificationSettingListRequest) (*GetNotificationSettingListResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNotificationSettingListResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetNotificationSettingList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instanceId}/notificationSettings/dataTraffic"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
GetSecurityGroup Get Security Group details
 ...
 @return ApiGetSecurityGroupRequest
*/
func (a *PubliccloudAPIService) GetSecurityGroup(ctx context.Context, securityGroupId string) ApiGetSecurityGroupRequest {
	return ApiGetSecurityGroupRequest{
		ApiService: a,
		ctx: ctx,
		securityGroupId: securityGroupId,
...
// Execute executes the request
//  @return SecurityGroup
func (a *PubliccloudAPIService) GetSecurityGroupExecute(r ApiGetSecurityGroupRequest) (*SecurityGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetSecurityGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetSecurityGroupFirewallRulesRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	securityGroupId string
	limit *int32
...
// Limit the number of results returned.
func (r ApiGetSecurityGroupFirewallRulesRequest) Limit(limit int32) ApiGetSecurityGroupFirewallRulesRequest {
	r.limit = &limit
	return r
}

// Return results starting from the given offset.
func (r ApiGetSecurityGroupFirewallRulesRequest) Offset(offset int32) ApiGetSecurityGroupFirewallRulesRequest {
	r.offset = &offset
	return r
}

func (r ApiGetSecurityGroupFirewallRulesRequest) Execute() (*GetSecurityGroupFirewallRulesResult, *http.Response, error) {
	return r.ApiService.GetSecurityGroupFirewallRulesExecute(r)
}
...
Get firewall rules for a security group
 ...
 @return ApiGetSecurityGroupFirewallRulesRequest
*/
func (a *PubliccloudAPIService) GetSecurityGroupFirewallRules(ctx context.Context, securityGroupId string) ApiGetSecurityGroupFirewallRulesRequest {
	return ApiGetSecurityGroupFirewallRulesRequest{
		ApiService: a,
		ctx: ctx,
		securityGroupId: securityGroupId,
...
// Execute executes the request
//  @return GetSecurityGroupFirewallRulesResult
func (a *PubliccloudAPIService) GetSecurityGroupFirewallRulesExecute(r ApiGetSecurityGroupFirewallRulesRequest) (*GetSecurityGroupFirewallRulesResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSecurityGroupFirewallRulesResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetSecurityGroupFirewallRules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/securityGroups/{securityGroupId}/firewallRules"
	localVarPath = strings.Replace(localVarPath, "{"+"securityGroupId"+"}", url.PathEscape(parameterValueToString(r.securityGroupId, "securityGroupId")), -1)
...
type ApiGetSecurityGroupListRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	limit *int32
	offset *int32
...
// Limit the number of results returned.
func (r ApiGetSecurityGroupListRequest) Limit(limit int32) ApiGetSecurityGroupListRequest {
	r.limit = &limit
	return r
}

// Return results starting from the given offset.
func (r ApiGetSecurityGroupListRequest) Offset(offset int32) ApiGetSecurityGroupListRequest {
	r.offset = &offset
	return r
}

// Filter by state
func (r ApiGetSecurityGroupListRequest) State(state SecurityGroupState) ApiGetSecurityGroupListRequest {
	r.state = &state
	return r
}

func (r ApiGetSecurityGroupListRequest) Execute() (*SecurityGroupList, *http.Response, error) {
	return r.ApiService.GetSecurityGroupListExecute(r)
}
...
List and filter security groups
 ...
 @return ApiGetSecurityGroupListRequest
*/
func (a *PubliccloudAPIService) GetSecurityGroupList(ctx context.Context) ApiGetSecurityGroupListRequest {
	return ApiGetSecurityGroupListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SecurityGroupList
func (a *PubliccloudAPIService) GetSecurityGroupListExecute(r ApiGetSecurityGroupListRequest) (*SecurityGroupList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetSecurityGroupList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetUserDataRequest) Execute() (*GetUserDataResult, *http.Response, error) {
...
GetUserData Get User Data supplied while launching the instance.
 ...
 @return ApiGetUserDataRequest
*/
func (a *PubliccloudAPIService) GetUserData(ctx context.Context, instanceId string) ApiGetUserDataRequest {
	return ApiGetUserDataRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return GetUserDataResult
func (a *PubliccloudAPIService) GetUserDataExecute(r ApiGetUserDataRequest) (*GetUserDataResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetUserDataResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.GetUserData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/instances/{instanceId}/userData"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
type ApiRefreshAutoScalingGroupImageRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	autoScalingGroupId string
}

func (r ApiRefreshAutoScalingGroupImageRequest) Execute() (*http.Response, error) {
	return r.ApiService.RefreshAutoScalingGroupImageExecute(r)
}
...
Refresh image for auto scaling group
 ...
 @return ApiRefreshAutoScalingGroupImageRequest
*/
func (a *PubliccloudAPIService) RefreshAutoScalingGroupImage(ctx context.Context, autoScalingGroupId string) ApiRefreshAutoScalingGroupImageRequest {
	return ApiRefreshAutoScalingGroupImageRequest{
		ApiService: a,
		ctx: ctx,
		autoScalingGroupId: autoScalingGroupId,
...
// Execute executes the request
func (a *PubliccloudAPIService) RefreshAutoScalingGroupImageExecute(r ApiRefreshAutoScalingGroupImageRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.RefreshAutoScalingGroupImage")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/autoScalingGroups/{autoScalingGroupId}/refreshImage"
	localVarPath = strings.Replace(localVarPath, "{"+"autoScalingGroupId"+"}", url.PathEscape(parameterValueToString(r.autoScalingGroupId, "autoScalingGroupId")), -1)
...
type ApiRevokeSecurityGroupFirewallRulesRequest struct {
	ctx context.Context
	ApiService PubliccloudAPI
	securityGroupId string
	revokeFirewallRulesOpts *RevokeFirewallRulesOpts
}

func (r ApiRevokeSecurityGroupFirewallRulesRequest) RevokeFirewallRulesOpts(revokeFirewallRulesOpts RevokeFirewallRulesOpts) ApiRevokeSecurityGroupFirewallRulesRequest {
	r.revokeFirewallRulesOpts = &revokeFirewallRulesOpts
	return r
}

func (r ApiRevokeSecurityGroupFirewallRulesRequest) Execute() (*http.Response, error) {
	return r.ApiService.RevokeSecurityGroupFirewallRulesExecute(r)
}
...
Remove firewall rules from security group
 ...
 @return ApiRevokeSecurityGroupFirewallRulesRequest
*/
func (a *PubliccloudAPIService) RevokeSecurityGroupFirewallRules(ctx context.Context, securityGroupId string) ApiRevokeSecurityGroupFirewallRulesRequest {
	return ApiRevokeSecurityGroupFirewallRulesRequest{
		ApiService: a,
		ctx: ctx,
		securityGroupId: securityGroupId,
...
// Execute executes the request
func (a *PubliccloudAPIService) RevokeSecurityGroupFirewallRulesExecute(r ApiRevokeSecurityGroupFirewallRulesRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.RevokeSecurityGroupFirewallRules")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/securityGroups/{securityGroupId}/revokeFirewallRules"
	localVarPath = strings.Replace(localVarPath, "{"+"securityGroupId"+"}", url.PathEscape(parameterValueToString(r.securityGroupId, "securityGroupId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.revokeFirewallRulesOpts == nil {
		return nil, reportError("revokeFirewallRulesOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.revokeFirewallRulesOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
type ApiUpdateNotificationSettingRequest struct {
	...
	instanceId string
	notificationSettingId string
	updateNotificationSettingOpts *UpdateNotificationSettingOpts
}

func (r ApiUpdateNotificationSettingRequest) UpdateNotificationSettingOpts(updateNotificationSettingOpts UpdateNotificationSettingOpts) ApiUpdateNotificationSettingRequest {
	r.updateNotificationSettingOpts = &updateNotificationSettingOpts
	return r
}

func (r ApiUpdateNotificationSettingRequest) Execute() (*NotificationSetting, *http.Response, error) {
...
UpdateNotificationSetting Update Notification Setting details
 ...
 @return ApiUpdateNotificationSettingRequest
*/
func (a *PubliccloudAPIService) UpdateNotificationSetting(ctx context.Context, instanceId string, notificationSettingId string) ApiUpdateNotificationSettingRequest {
	return ApiUpdateNotificationSettingRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return NotificationSetting
func (a *PubliccloudAPIService) UpdateNotificationSettingExecute(r ApiUpdateNotificationSettingRequest) (*NotificationSetting, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.UpdateNotificationSetting")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateNotificationSettingOpts == nil {
		return localVarReturnValue, nil, reportError("updateNotificationSettingOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateNotificationSettingOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
...
type ApiUpdateSecurityGroupRequest struct {
	...
	ApiService PubliccloudAPI
	securityGroupId string
	updateSecurityGroupOpts *UpdateSecurityGroupOpts
}

func (r ApiUpdateSecurityGroupRequest) UpdateSecurityGroupOpts(updateSecurityGroupOpts UpdateSecurityGroupOpts) ApiUpdateSecurityGroupRequest {
	r.updateSecurityGroupOpts = &updateSecurityGroupOpts
	return r
}
...
Update a Security Group
 ...
 @return ApiUpdateSecurityGroupRequest
*/
func (a *PubliccloudAPIService) UpdateSecurityGroup(ctx context.Context, securityGroupId string) ApiUpdateSecurityGroupRequest {
	return ApiUpdateSecurityGroupRequest{
		ApiService: a,
		ctx: ctx,
		securityGroupId: securityGroupId,
...
// Execute executes the request
//  @return SecurityGroup
func (a *PubliccloudAPIService) UpdateSecurityGroupExecute(r ApiUpdateSecurityGroupRequest) (*SecurityGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PubliccloudAPIService.UpdateSecurityGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateSecurityGroupOpts == nil {
		return localVarReturnValue, nil, reportError("updateSecurityGroupOpts is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateSecurityGroupOpts
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["X-LSW-Auth"]; ok {
